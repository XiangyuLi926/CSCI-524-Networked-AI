...
void ProductionManager::manageBuildOrderQueue() 
{
	...
	while (!_queue.isEmpty()) 
	{
		...
		//while ((!_queue.isEmpty() && currentItem.metaType.getUnitType() == BWAPI::UnitTypes::Protoss_Gateway && BWAPI::Broodwar->self()->completedUnitCount(BWAPI::UnitTypes::Protoss_Gateway) >= 6))
		//{
